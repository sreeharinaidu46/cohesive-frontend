      ...
      <nav>
        <div className="leftNavbar">
          <div style={{ marginRight: "auto" }}>
            {currentUserrr && currentUserrr.name}
          </div>
          <button className={"rule-btn2"} onClick={viewUserHandler}>
            viewUser
          </button>
          <div>Total amount:{currentUserrr && currentUserrr.totalAmount}</div>
          <div>Amount spent:{currentUserrr && currentUserrr.amountSpent}</div>
          <div>
            Remaining amount:{currentUserrr && currentUserrr.remainingAmount}
          </div>
